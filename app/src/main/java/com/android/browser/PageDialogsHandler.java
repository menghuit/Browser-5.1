...
public class PageDialogsHandler {
    ...
    private AlertDialog.Builder createSslCertificateDialog(SslCertificate certificate,
            SslError error) {
        View certificateView = /*certificate.inflateCertificateView(mContext)*/reflectInflateCertificateView(mContext, certificate);
//        final LinearLayout placeholder =
//                (LinearLayout)certificateView.findViewById(android.R.id.placeholder);
//
...
//            successString.setText(/*android.R.string.ssl_certificate_is_valid*/"This certificate is valid.");
        } else {
...
//            }
        ...
        return new AlertDialog.Builder(mContext)
                .setTitle(/*com.android.internal.R.string.ssl_certificate*/"Security certificate")
                .setIcon(iconId)
                .setView(certificateView);
    }

    private View reflectInflateCertificateView(Context ctx, SslCertificate certificate) {
        final Method inflateCertificateView;
        try {
            inflateCertificateView = certificate.getClass().getDeclaredMethod("inflateCertificateView", Context.class);
            inflateCertificateView.setAccessible(true);
            return (View) inflateCertificateView.invoke(certificate, ctx);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
