...
import imports.android.provider.BrowserContract.Accounts;
import imports.android.provider.BrowserContract.Bookmarks;
import imports.android.provider.BrowserContract.ChromeSyncColumns;
import imports.android.provider.BrowserContract.Combined;
import imports.android.provider.BrowserContract.History;
import imports.android.provider.BrowserContract.Images;
import imports.android.provider.BrowserContract.Searches;
import imports.android.provider.BrowserContract.Settings;
import imports.android.provider.BrowserContract.SyncState;
...
import imports.com.android.common.content.SyncStateContentProviderHelper;
            ...
            if (oldDbFile.exists()) {
                ...
                try {
                    ...
                    c = oldDb.query(table,
                            ...
                            /*BookmarkColumns.TOUCH_ICON*/"touch_icon", // 3
    ...
    public Uri insertInTransaction(Uri uri, ContentValues values, boolean callerIsSyncAdapter) {
        ...
        if (match == LEGACY) {
            ...
            if (bookmark == null || bookmark == 0) {
                ...
                values.remove(/*BookmarkColumns.USER_ENTERED*/"user_entered");
