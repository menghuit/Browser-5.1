...
public class ScrollerView extends FrameLayout {
    ...
    // D:by zd.{StrictMode.Span} is hidden.
    /**
...
//    private StrictMode.Span mFlingStrictSpan = null;
    ...
    public ScrollerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int[] attrsArray = new int[]{android.R.attr.fillViewport};
        TypedArray a =
            context.obtainStyledAttributes(attrs, attrsArray, defStyle, 0);
...
//        }
    ...
    // A:by zd. The below is copied from view - These apis is hidden.
