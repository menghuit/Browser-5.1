...
public class BreadCrumbView extends LinearLayout implements OnClickListener {
    ...
    private void init(Context ctx) {
        ...
        int[] attrsArray = new int[]{android.R.attr.dividerVertical};
        TypedArray a = mContext.obtainStyledAttributes(/*com.android.internal.R.styleable.Theme*/attrsArray);
        mSeparatorDrawable = a.getDrawable(/*com.android.internal.R.styleable.Theme_dividerVertical*/0);
        a.recycle();
