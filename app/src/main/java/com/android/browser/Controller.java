...
import imports.android.provider.BrowserContract;
import imports.android.provider.BrowserContract.Images;
...
import com.android.browser.extras.WebViewCompat;
...
public class Controller
    ...
    static final void sharePage(Context c, String title, String url,
        ...
        send.putExtra(/*Browser.EXTRA_SHARE_FAVICON*/"share_favicon", favicon);
        send.putExtra(/*Browser.EXTRA_SHARE_SCREENSHOT*/"share_screenshot", screenshot);
        try {
...
//        WebView.enablePlatformNotifications();
    ...
    public void getVisitedHistory(final ValueCallback<String[]> callback) {
        AsyncTask<Void, Void, String[]> task =
            ...
            public String[] doInBackground(Void... unused) {
                // M:By zd.{Browser.getVisitedHistory} is pending api.
            ...
            public final String[] getVisitedHistory(ContentResolver cr) {
                        Cursor c = null;
                        String[] str = null;
                        try {
                            ...
                            c = cr.query(BrowserContract.History.CONTENT_URI, projection, BrowserContract.History.VISITS + " > 0", null, null);
    ...
    public void onReceivedHttpAuthRequest(Tab tab, WebView view,
        ...
        if (username != null && password != null) {
            ...
            if (tab.inForeground() && !/*handler.suppressDialog()*/suppressDialog(handler)) {
    ...
    // A:By zd. {HttpAuthHandler#suppressDialog} is hide
    private boolean suppressDialog(HttpAuthHandler handler) {
        try {
            final Method suppressDialog = handler.getClass().getMethod("suppressDialog");
            suppressDialog.setAccessible(true);
            return (boolean) suppressDialog.invoke(handler);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.dump_nav_menu_id:
                // D:by zd.debugDump is deprecated
    ...
    public Intent createBookmarkCurrentPageIntent(boolean editExisting) {
        ...
        String touchIconUrl = /*w.getTouchIconUrl()*/WebViewCompat.getTouchIconUrl(w);
    ...
    static Bitmap createScreenshot(WebView view, int width, int height) {
        if (view == null || view.getContentHeight() == 0
                || WebViewCompat.getContentWidth(view) == 0) {
            return null;
        }
        ...
        int contentWidth = WebViewCompat.getContentWidth(view);
