...
import com.android.browser.extras.SearchManagerCompat;
...
public class DefaultSearchEngine implements SearchEngine {
    ...
    public static DefaultSearchEngine create(Context context) {
        ...
        ComponentName name = /*searchManager.getWebSearchActivity()*/SearchManagerCompat.getWebSearchActivity(searchManager);
    ...
    public Cursor getSuggestions(Context context, String query) {
        SearchManager searchManager =
                (SearchManager) context.getSystemService(Context.SEARCH_SERVICE);
        return /*searchManager.getSuggestions(mSearchable, query)*/SearchManagerCompat.getSuggestions(searchManager, mSearchable, query);
    }
